          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-zinc-200 text-zinc-900 text-center space-y-6 animate-scaleIn">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-zinc-500 max-w-md mx-auto leading-relaxed">
                Tu formulario de Debida Diligencia para Persona Jurídica ha sido formalizado y guardado con éxito. Un oficial de cumplimiento revisará tu documentación a la brevedad.
              </p>
            </div>
